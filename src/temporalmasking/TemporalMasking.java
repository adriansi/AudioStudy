 ...
 */
public class TemporalMasking extends AppletController {
    ...
    public void start() {
        ...
        URL wavurl = null;
        try {
            wavurl = new URL(codebase,"file:///H:/dev/Workspace/AudioStudy/src/examples/data/sine440.wav");
